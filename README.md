...
<head>
    ...
    <title>Valentine's Day for Our Section</title>
    <style>
        body {
...
<body>
    <h1>Happy Valentine's Day, Anthropology 💖</h1>
    <div class="heart">❤️</div>
    <p>Spread the love and celebrate together!</p>
    ...
    <footer>
        Made with ❤️ for Our Section. Customize and share!
    </footer>
</body>
</html>
